...
//#endif
    ...
    func makeTestData () {
        let context = persistentContainer.viewContext
        let test1 = TDMTune.makeInstance(context: context, displayName: "first test tune", notes: "no notes") as! TDMTune
        let test2 = TDMTune.makeInstance(context: context, displayName: "second test tune", notes: "some notes") as! TDMTune
        let test3 = TDMTune.makeInstance(context: context, displayName: "third test tune", notes: "some more notes") as! TDMTune
        ...
        testSet.addTunes([test3,test2, test1])
        testSet2.addTunes([test1, test2])
        
        let collection1 = TDMCollection.makeInstance(context: context, displayName: "myCollection")
        collection1.addSearchableItems([test1,testSet2])
        saveContext()
